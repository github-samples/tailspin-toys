 ...
 * @returns The rating constrained to the range from 0 through 5.
 */
 ...
 *
 * @param rating - The rating to format, or null when it has not been rated.
 * @returns A five-position star display string or a not-rated message.
 */
