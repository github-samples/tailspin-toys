...
/**
 * Runs generated migration statements in a single SQLite transaction.
 *
 * @param sqlite - Node SQLite connection that owns the transaction.
 * @param queries - Ordered migration statements generated by Drizzle.
 * @returns Nothing.
 */
...
/**
 * Creates a Drizzle client for a local SQLite connection URL.
 *
 * @param url - Local `file:` URL or `:memory:` connection; defaults to `DATABASE_URL` or the development database.
 * @returns A Drizzle database client backed by Node's SQLite driver.
 */
...
/**
 * Creates both sides of the database connection for migration workflows.
 *
 * @param url - Local `file:` URL or `:memory:` connection; defaults to `DATABASE_URL` or the development database.
 * @returns The Drizzle client and underlying Node SQLite connection.
 */
...
/**
 * Gets the shared database client used by pages during the static build.
 *
 * @returns The cached Drizzle client, creating it on first access.
 */
