...
Repository coding standards are documented in [`.github/copilot-instructions.md`](.github/copilot-instructions.md), including comment intent, TSDoc requirements for exported data-layer functions, and documentation expectations for Astro component props.
