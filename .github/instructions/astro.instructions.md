...
- Define and document a `Props` interface in frontmatter for every reusable component so its public API is self-explanatory
...
- Comment intent and non-obvious decisions, not mechanics that are already clear from the code
